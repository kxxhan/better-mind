...
public class CommunityController {
	...
	public ResponseEntity<List<CommunityPostReq>> getAllArticle(@RequestParam int page, int size){
	...
	@ApiOperation(value = "글 내용", notes = "<strong>글 작성</strong>") 
	@ApiResponses({
		@ApiResponse(code = 200, message = "성공"),
		@ApiResponse(code = 401, message = "토큰 인증 실패"),
		@ApiResponse(code = 500, message = "서버 오류")
	})
	public ResponseEntity<BaseResponseBody> getOneArticle(@RequestBody CommunityPostReq communityPostReq){
